...
public:
    void add_vertex(char vertex, const unordered_map<char, int>& edges)
    {
        vertices.insert(unordered_map<char, const unordered_map<char, int>>::value_type(vertex, edges));
    }
...
{
    Graph g;
    g.add_vertex('A', { {'B', 3}, {'C', 1} });
    g.add_vertex('B', { {'A', 3}, {'E', 2}, {'D', 4} });
    g.add_vertex('C', { {'A', 1}, {'E', 5}, {'F', 6} });
    g.add_vertex('D', { {'F', 2}, {'E', 3}, {'B', 4} });
